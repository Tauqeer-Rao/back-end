...
//Added by me
//This one is working too , test it
const createProduct = async (req, res) => {
  try {
    console.log("In Create Product Controlller")
...
module.exports = { createProduct, fetchAllProducts, fetchProductById, updateProduct, getAllProducts }
